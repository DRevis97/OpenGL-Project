...
int main()
{
	...
	Shader shader("Shaders/advancedVertexShader.txt", "Shaders/advancedFragmentShader.txt");
	Shader rock_shader("Shaders/advancedRockVertexShader.txt", "Shaders/advancedRockFragmentShader.txt");
	//Shader screen_shader("Shaders/screenVertexShader.txt", "Shaders/screenFragmentShader.txt");
	//Shader skybox_shader("Shaders/skyboxVertexShader.txt", "Shaders/skyboxFragmentShader.txt");
	...
	*/
	...
	//unsigned int floor_texture = loadTexture("Resources/metal.png");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		rock_shader.use();
		rock_shader.setInt("texture_diffuse1", 0);

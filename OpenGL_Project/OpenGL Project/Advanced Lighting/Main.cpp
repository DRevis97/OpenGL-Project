...
void getInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS && !hdr_key_pressed)
	{
		hdr = !hdr;
...
unsigned int loadTexture(char const * path, bool gamma_correction)
{
	...
	if (data)
	{
		...
		{
			internal_format = gamma_correction ? GL_SRGB : GL_RGBA;
			data_format = GL_RGBA;
		}
...
int main()
{
	...
	Shader shader("Shaders/advancedLightingVertexShader.txt", "Shaders/advancedLightingFragmentShader.txt");
	Shader hdr_shader("Shaders/hdrVertexShader.txt", "Shaders/hdrFragmentShader.txt");


	unsigned int wood_texture = loadTexture("Resources/wood.png", true);
...
/*
	...
	*/
	...
	//unsigned int cube_texture = loadTexture("Resources/container.jpg");
